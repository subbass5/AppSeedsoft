...
public class Fragment_CheckinV2 extends Fragment{
    ...
    private TextView tv1,tv_time,tv_date,tv_location,tv_lbl_place,tv_lbl_lastactivity,tv_day, tv_status_history0, tv_status_history1
            ,tv_place0,tv_place1,tv_time_his0,tv_time_his1;
    ...
    public Fragment_CheckinV2(String apiKey){
        this.apiKey = apiKey;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_checkin_v2,container,false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Typeface customFontBold= Typeface.createFromAsset(getActivity().getAssets(),"fonts/Kanit.ttf");
...
//        tv1 = (TextView) view.findViewById(R.id.txt_name_user);
        ...
        tv_status_history0 = (TextView) view.findViewById(R.id.tv_status_history0);
        tv_status_history1 = (TextView) view.findViewById(R.id.tv_status_history1);

        tv_place0  = (TextView) view.findViewById(R.id.tv_place0);
        tv_place1  = (TextView) view.findViewById(R.id.tv_place1);

        tv_time_his0 = (TextView) view.findViewById(R.id.tv_his_time0);
        tv_time_his1 = (TextView) view.findViewById(R.id.tv_his_time1);
//        tv_state_now  = (TextView) view.findViewById(R.id.txt_state_now);
        tv_day = (TextView) view.findViewById(R.id.txt_day);

        tv_lbl_lastactivity = (TextView) view.findViewById(R.id.lbl_lastactivity);
        tv_lbl_place = (TextView) view.findViewById(R.id.txt_local_lbl) ;


        tv_location.setTypeface(customFontBold);
        tv_time.setTypeface(customFontBold);
        tv_date.setTypeface(customFontBold);
        tv_day.setTypeface(customFontBold);
        tv_status_history0.setTypeface(customFontBold);
        tv_status_history1.setTypeface(customFontBold);
        tv_place0.setTypeface(customFontBold);
        tv_place1.setTypeface(customFontBold);
        tv_time_his0.setTypeface(customFontBold);
        tv_time_his1.setTypeface(customFontBold);
        btnCheck.setTypeface(customFontBold);
        tv_lbl_lastactivity.setTypeface(customFontBold);
        tv_lbl_place.setTypeface(customFontBold);
    ...
    private void init(){
        try{
            ...
            Log.e("Error init() checkinv2",e.getMessage());
        }

    }

    private void setUiFragment(String data){
...
//                Toast.makeText(getContext(), ""+currentLocation.getNamelocation(), Toast.LENGTH_SHORT).show();
...
//                tv1.setText(""+profile.getNameStaff());
            ...
            Log.e("Error at Checkin fragment setUI",e.getMessage());
            if(progress.isShowing()){
                progress.dismiss();
            }
        }
        ...
        try {
            ...
            if (profile.getHistory_Array()!=null){
                ...
                try {
                    ...
                    JSONObject historyJSON2 = new JSONObject(value.get(1).toString());

                    tv_status_history0.setText(""+historyJson.getString("state"));
                    tv_status_history1.setText(""+historyJSON2.getString("state"));

                    tv_place0.setText(""+historyJson.getString("name"));
                    tv_place1.setText(""+historyJSON2.getString("name"));

                    tv_time_his0.setText(""+historyJson.getString("time"));
                    tv_time_his1.setText(""+historyJSON2.getString("time"));
                ...
                upDateUI(state_check);
            }


        }catch (Exception e){
            Log.e("setHistoryShow() checkin class",e.getMessage());
        }
    }
        ...
        try{
            ...
            builder.setPositiveButton("ใช่", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    setHistoryShow();
//                    Toast.makeText(getContext(), ""+profile.getHistory_Array(), Toast.LENGTH_SHORT).show();
